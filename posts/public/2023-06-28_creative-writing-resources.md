...
- Consider learning how to construct crosswords! The craft of crossword construction acts as an excellent shorthand for learning how to compose a piece of writing. In more detail:
- In order for a puzzle to interlock well, you often need to make sacrifices in one area to make other areas significantly better.
- Writing crossword clues acts as a boot camp in how to create inferences. The adage of "show, not tell" can be alternatively phrased as "clue, not definition".
- Constructing crosswords exposes you to a wide set of vocabulary.
- Aside: The director of the Benoit Blanc mysteries, Rian Johnson, describes the craft of writing a murder mystery as being like a crossword puzzle ([source](https://youtu.be/98ArZ8w5K9s?si=S-9at0Qgquz_B3Cz&t=1173)).
